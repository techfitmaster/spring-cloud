package com.huzhengxing.grpcinterface.api;
...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest,
      com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest.class,
      responseType = com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest,
      com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest, com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest, com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest request,
        io.grpc.stub.StreamObserver<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest,
                com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse sayHello(com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse> sayHello(
        com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.huzhengxing.grpcinterface.api.HelloWorldService.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.huzhengxing.grpcinterface.api.HelloWorldService.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.huzhengxing.grpcinterface.api.HelloWorldService.getDescriptor();
    }
